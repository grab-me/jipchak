...
const RecordList = () => {
  ...
  return (
    <CrayonWrapper className="items-center">
      ...
      <div 
        ref={scrollRef}
        className="flex-1 w-full overflow-y-auto pt-[8%] flex flex-col gap-[1%] z-10 no-scrollbar"
      >
        {records.length === 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute top-[2%] left-[2%] z-10 flex flex-col items-center">
                    {success ? (
                      <>
                        <div className="relative w-[clamp(16px,2.5vw,24px)] aspect-square bg-gradient-to-br from-yellow-200 via-yellow-400 to-yellow-600 rounded-full flex items-center justify-center border-[clamp(0.5px,0.1vw,1.5px)] border-yellow-600 shadow-sm z-20">
                        ...
                        <div className="flex -mt-[10%] gap-[0.1vw] z-10">
                          {/* 리본 극초소형화 */}
                      ...
                      <div className="relative w-[clamp(14px,2.2vw,22px)] aspect-square bg-white rounded-[255px_15px_225px_15px/15px_225px_15px_255px] border-[clamp(0.8px,0.15vw,1.5px)] border-crayon-line shadow-sm z-20 flex items-center justify-center">
