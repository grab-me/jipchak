...
const CrayonWrapper = ({ children, showCharacter = true, className = '' }: CrayonWrapperProps) => {
  return (
    ...
    >
      ...
      <div className="absolute inset-[clamp(3px,0.8vw,8px)] border-[clamp(1px,0.3vw,3px)] border-crayon-line opacity-80 pointer-events-none rounded-[225px_15px_255px_15px/15px_255px_15px_225px] -rotate-1" />
